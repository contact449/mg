 ...
 *
 *  Champs POST (aucun champ cache, aucun token CSRF) :
...
var CFG = {
  ...
  // Optionnel : protege ton endpoint. '' = ouvert.
  API_KEY: '',

  // Recupere aussi les champs du <form> charge (defauts + eventuels hidden futurs).
  AUTO_FORM_DEFAULTS: true
};
